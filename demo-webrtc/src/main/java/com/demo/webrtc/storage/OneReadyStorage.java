package com.demo.webrtc.storage;

import com.demo.webrtc.config.OneReadyConfig;
...
public class OneReadyStorage {
     ...
     * key 发起呼叫方id
     */
    private static final ConcurrentHashMap<String, OneReadyConfig> call = new ConcurrentHashMap<>();
    /**
     * key 应答方id
     */
    private static final ConcurrentHashMap<String, OneReadyConfig> answer = new ConcurrentHashMap<>();
